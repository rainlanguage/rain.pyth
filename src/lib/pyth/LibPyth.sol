...
library LibPyth {
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_ARB_USD =
        uint256(0x000000000000000000000000000000000043727970746f2e4152422f555344ee);
    /// BTC/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_BTC_USD =
        uint256(0x000000000000000000000000000000000043727970746f2e4254432f555344ee);
    /// WBTC/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_WBTC_USD =
        uint256(0x0000000000000000000000000000000043727970746f2e574254432f555344ef);
    /// CBBTC/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_CBBTC_USD =
        uint256(0x00000000000000000000000000000043727970746f2e43424254432f555344f0);
    /// DOT/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_DOT_USD =
        uint256(0x000000000000000000000000000000000043727970746f2e444f542f555344ee);
    /// ENA/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_ENA_USD =
        uint256(0x000000000000000000000000000000000043727970746f2e454e412f555344ee);
    /// ETH/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_ETH_USD =
        uint256(0x000000000000000000000000000000000043727970746f2e4554482f555344ee);
    /// WETH/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_WETH_USD =
        uint256(0x0000000000000000000000000000000043727970746f2e574554482f555344ef);
    /// WSTETH/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_WSTETH_USD =
        uint256(0x000000000000000000000000000043727970746f2e5753544554482f555344f1);
    /// LINK/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_LINK_USD =
        uint256(0x0000000000000000000000000000000043727970746f2e4c494e4b2f555344ef);
    /// PEPE/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_PEPE_USD =
        uint256(0x0000000000000000000000000000000043727970746f2e504550452f555344ef);
    /// PYTH/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_PYTH_USD =
        uint256(0x0000000000000000000000000000000043727970746f2e505954482f555344ef);
    /// UNI/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_UNI_USD =
        uint256(0x000000000000000000000000000000000043727970746f2e554e492f555344ee);
    /// XAUT/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_XAUT_USD =
        uint256(0x0000000000000000000000000000000043727970746f2e584155542f555344ef);
    /// XRP/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_CRYPTO_XRP_USD =
        uint256(0x000000000000000000000000000000000043727970746f2e5852502f555344ee);
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_GOOG_USD =
        0x000000000000000000000000004571756974792e55532e474f4f472f555344f2;
    /// Amazon.
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_AMZN_USD =
        0x000000000000000000000000004571756974792e55532e414d5a4e2f555344f2;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_AMZN_USD_PRE =
        0x82c59e36a8e0247e15283748d6cd51f5fa1019d73fbf3ab6d927e17d9e357a7f;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_AMZN_USD_PRE =
        0x0000000000000000004571756974792e55532e414d5a4e2f5553442e505245f6;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_AMZN_USD_POST =
        0x62731dfcc8b8542e52753f208248c3e73fab2ec15422d6f65c2decda71ccea0d;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_AMZN_USD_POST =
        0x00000000000000004571756974792e55532e414d5a4e2f5553442e504f5354f7;
    /// Apple.
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_AAPL_USD =
        0x000000000000000000000000004571756974792e55532e4141504c2f555344f2;
    /// Microsoft.
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_MSFT_USD =
        0x000000000000000000000000004571756974792e55532e4d5346542f555344f2;
    /// Tesla.
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_TSLA_USD =
        0x000000000000000000000000004571756974792e55532e54534c412f555344f2;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_TSLA_USD_PRE =
        0x42676a595d0099c381687124805c8bb22c75424dffcaa55e3dc6549854ebe20a;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_TSLA_USD_PRE =
        0x0000000000000000004571756974792e55532e54534c412f5553442e505245f6;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_TSLA_USD_POST =
        0x2a797e196973b72447e0ab8e841d9f5706c37dc581fe66a0bd21bcd256cdb9b9;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_TSLA_USD_POST =
        0x00000000000000004571756974792e55532e54534c412f5553442e504f5354f7;
    /// Nvidia.
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_NVDA_USD =
        0x000000000000000000000000004571756974792e55532e4e5644412f555344f2;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_NVDA_USD_PRE =
        0x61c4ca5b9731a79e285a01e24432d57d89f0ecdd4cd7828196ca8992d5eafef6;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_NVDA_USD_PRE =
        0x0000000000000000004571756974792e55532e4e5644412f5553442e505245f6;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_NVDA_USD_POST =
        0x25719379353a508b1531945f3c466759d6efd866f52fbaeb3631decb70ba381f;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_NVDA_USD_POST =
        0x00000000000000004571756974792e55532e4e5644412f5553442e504f5354f7;
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_META_USD =
        0x000000000000000000000000004571756974792e55532e4d4554412f555344f2;
    /// Gamestop
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_GME_USD =
        0x00000000000000000000000000004571756974792e55532e474d452f555344f1;
    /// MicroStrategy (MSTR)
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_MSTR_USD =
        0x000000000000000000000000004571756974792e55532e4d5354522f555344f2;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_MSTR_USD_PRE =
        0x1a11eb21c271f3127e4c9ec8a0e9b1042dc088ccba7a94a1a7d1aa37599a00f6;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_MSTR_USD_PRE =
        0x0000000000000000004571756974792e55532e4d5354522f5553442e505245f6;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_MSTR_USD_POST =
        0xd8b856d7e17c467877d2d947f27b832db0d65b362ddb6f728797d46b0a8b54c0;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_MSTR_USD_POST =
        0x00000000000000004571756974792e55532e4d5354522f5553442e504f5354f7;
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_BRK_B_USD =
        0x0000000000000000000000004571756974792e55532e42524b2d422f555344f3;
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_SPLG_USD =
        0x000000000000000000000000004571756974792e55532e53504c472f555344f2;
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_IAU_USD =
        0x00000000000000000000000000004571756974792e55532e4941552f555344f1;
    /// COIN/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_COIN_USD =
        0x000000000000000000000000004571756974792e55532e434f494e2f555344f2;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_COIN_USD_PRE =
        0x8bdee6bc9dc5a61b971e31dcfae96fc0c7eae37b2604aa6002ad22980bd3517c;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_COIN_USD_PRE =
        0x0000000000000000004571756974792e55532e434f494e2f5553442e505245f6;
    bytes32 constant PRICE_FEED_ID_EQUITY_US_COIN_USD_POST =
        0x5c3bd92f2eed33779040caea9f82fac705f5121d26251f8f5e17ec35b9559cd4;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_COIN_USD_POST =
        0x00000000000000004571756974792e55532e434f494e2f5553442e504f5354f7;
    /// SIVR/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_SIVR_USD =
        uint256(0x000000000000000000000000004571756974792e55532e534956522f555344f2);
    /// CRCL/USD
    bytes32 constant PRICE_FEED_ID_EQUITY_US_CRCL_USD =
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_CRCL_USD =
        uint256(0x000000000000000000000000004571756974792e55532e4352434c2f555344f2);
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_CRCL_USD_PRE =
        uint256(0x0000000000000000004571756974792e55532e4352434c2f5553442e505245f6);
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_CRCL_USD_POST =
        uint256(0x00000000000000004571756974792e55532e4352434c2f5553442e504f5354f7);
    /// PPLT/USD
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_PPLT_USD =
        uint256(0x000000000000000000000000004571756974792e55532e50504c542f555344f2);
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_BMNR_USD =
        uint256(0x000000000000000000000000004571756974792e55532e424d4e522f555344f2);
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_BMNR_USD_PRE =
        uint256(0x0000000000000000004571756974792e55532e424d4e522f5553442e505245f6);
    ...
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_BMNR_USD_POST =
        uint256(0x00000000000000004571756974792e55532e424d4e522f5553442e504f5354f7);
    /// RKLB/USD
    bytes32 constant PRICE_FEED_ID_EQUITY_US_RKLB_USD =
        0x40589e289317e4fbd997b1a267606e20a1cc7c3e4689f9e5a5992957917816c8;
    // slither-disable-next-line too-many-digits
    uint256 constant PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_RKLB_USD =
        uint256(0x000000000000000000000000004571756974792e55532e524b4c422f555344f2);
    ...
    function getPriceFeedId(IntOrAString feedSymbolIntOrAString) internal pure returns (bytes32) {
        ...
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_COIN_USD_PRE) {
            return PRICE_FEED_ID_EQUITY_US_COIN_USD_PRE;
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_COIN_USD_POST) {
            return PRICE_FEED_ID_EQUITY_US_COIN_USD_POST;
        ...
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_AMZN_USD_PRE) {
            return PRICE_FEED_ID_EQUITY_US_AMZN_USD_PRE;
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_AMZN_USD_POST) {
            return PRICE_FEED_ID_EQUITY_US_AMZN_USD_POST;
        ...
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_TSLA_USD_PRE) {
            return PRICE_FEED_ID_EQUITY_US_TSLA_USD_PRE;
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_TSLA_USD_POST) {
            return PRICE_FEED_ID_EQUITY_US_TSLA_USD_POST;
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_NVDA_USD) {
            return PRICE_FEED_ID_EQUITY_US_NVDA_USD;
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_NVDA_USD_PRE) {
            return PRICE_FEED_ID_EQUITY_US_NVDA_USD_PRE;
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_NVDA_USD_POST) {
            return PRICE_FEED_ID_EQUITY_US_NVDA_USD_POST;
        ...
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_MSTR_USD_PRE) {
            return PRICE_FEED_ID_EQUITY_US_MSTR_USD_PRE;
        } else if (feedSymbol == PRICE_FEED_SYMBOL_INTORASTRING_EQUITY_US_MSTR_USD_POST) {
            return PRICE_FEED_ID_EQUITY_US_MSTR_USD_POST;
